    ...
    $.fn.material_select = function (callback) {
        $(this).each(function () {
            ...
            var appendOptionWithIcon = function (select, option, type) {
                ...
                var selectedClass = option.is(':selected') ? ' checked ' : '';
                var multipleCheckbox = multiple ? '<input type="checkbox"' + disabledClass + selectedClass + '/><label></label>' : '';
            ...
            if (multiple) {
                $select.find("option:selected:not(:disabled)").each(function () {
                    var index;
                    if ($(this).parent().prop("tagName") === "OPTGROUP") {
                        index = $(this).parent().index() + 1 + $(this).index();
                    } else {
                        index = $(this).index();
                    }
            ...
            function updateElements(objects, scrolled) {
                objects.each(function () {
                    ...
                    if (options.top <= scrolled && options.bottom >= scrolled && !$(this).hasClass('pinned')) {
                        ...
                        $(this).parent().find(".pin-content").css("top", 64);
                    }
                    ...
                    if (scrolled < options.top && !$(this).hasClass('pin-top')) {
                        ...
                        $target.find(".pin-content").css("top", 0);
                    }
